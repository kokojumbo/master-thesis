...
import com.master.thesis.utils.ImbalancedUtils;
import com.master.thesis.utils.MapUtil;
...
import static com.master.thesis.utils.ImbalancedUtils.getParametersForKMeans;
...
public class DBScanImbalancedAlgorithm implements ImbalancedAlgorithm {
     ...
     */
    public static class ClusterImbalancedAlgorithmParamTest implements ImbalancedAlgorithm {
        ...
        public void start() throws Exception {
            ...
            Instances minorityInstances = new Instances(data);
            Instances majorityInstances = new Instances(data);
            ImbalancedUtils.separateDecisionClasses(data, minorityInstances, majorityInstances);
        ...
        private double getSMOTEPercentage(Instances instances) {
            ...
            try {
                ImbalancedUtils.separateDecisionClasses(newInstances, minorityInstances, majorityInstances);
            } catch (Exception e) {
                e.printStackTrace();
            }
